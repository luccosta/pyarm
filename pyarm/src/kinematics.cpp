...
void positionCallback(const geometry_msgs::Point& target)  // Pesquisar mais sobre a recepção desse tipo
{
...
int main(int argc, char **argv)
{
  ...
  ros::Subscriber sub = n.subscribe("coordinates", 1000, positionCallback); // Necessita de um spinner
